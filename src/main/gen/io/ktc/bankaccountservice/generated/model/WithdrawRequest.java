...
public class WithdrawRequest implements Serializable {
   ...
   */
  public WithdrawRequest(LocalDate date, BigDecimal amount) {
    this.date = date;
    this.amount = amount;
  }

  public WithdrawRequest date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  */
  ...
  public WithdrawRequest amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  */
  @NotNull @Valid 
  @Schema(name = "amount", description = "withdrawal amount", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("amount")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, withdrawRequest.date) &&
