...
public class GetTransactionsResponse implements Serializable {
  ...
  @Valid
  private List<@Valid Transaction> items;

  public GetTransactionsResponse items(List<@Valid Transaction> items) {
    this.items = items;
    return this;
  }

  public GetTransactionsResponse addItemsItem(Transaction itemsItem) {
    if (this.items == null) {
  ...
  */
  ...
  @JsonProperty("items")
  public List<@Valid Transaction> getItems() {
    return items;
  }

  public void setItems(List<@Valid Transaction> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, getTransactionsResponse.items);
  }
