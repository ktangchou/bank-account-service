...
public class Transaction implements Serializable {
   ...
   */
  public Transaction(Long id, LocalDate date, BigDecimal amount, TransactionType transactionType) {
    this.id = id;
    this.date = date;
    this.amount = amount;
  ...
  */
  @NotNull 
  @Schema(name = "id", description = "transaction id", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("id")
  public Long getId() {
    return id;
  }
  ...
  */
  @NotNull @Valid 
  @Schema(name = "amount", description = "transaction amount", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("amount")
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, date, amount, transactionType);
  }
